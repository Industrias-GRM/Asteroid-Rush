...
function hasValidTermsForServer() {
  try {
    ...
    const cur = (typeof getCurrentAppVersion === 'function') ? getCurrentAppVersion() : ((typeof Platform !== 'undefined' && Platform.manifest && Platform.manifest.version) ? Platform.manifest.version : '1.0');
